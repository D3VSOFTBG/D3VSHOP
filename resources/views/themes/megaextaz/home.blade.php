...
<head>
    ...
    <title>{{Cache::get('shop_name')}}</title>

    <link rel="icon" href="/themes/{{Cache::get('theme_name')}}/favicon.ico" type="image/x-icon">
    <script src="/themes/{{Cache::get('theme_name')}}/js/libs/jquery-1.11.1.js"></script>
    <script src="/themes/{{Cache::get('theme_name')}}/js/libs/modernizr.js"></script>
    <script type="text/javascript" src="/themes/{{Cache::get('theme_name')}}/js/libs/countdown/jquery.plugin.min.js">
    </script>
    <script type="text/javascript" src="/themes/{{Cache::get('theme_name')}}/js/libs/countdown/jquery.countdown.js">
    </script>
    <script type="text/javascript" src="/themes/{{Cache::get('theme_name')}}/js/libs/jquery.jcarousel.min.js"></script>
    <script type="text/javascript" src="/themes/{{Cache::get('theme_name')}}/js/libs/jquery.localScroll.min.js">
    </script>
    <script type="text/javascript" src="/themes/{{Cache::get('theme_name')}}/js/libs/jquery.scrollTo.min.js"></script>

    <link rel="stylesheet" href="/themes/{{Cache::get('theme_name')}}/css/style.css">
</head>
...
<body onload="loaded();">
    <div class="body">
        ...
        <div class="recommend cnt_wrapp clearfix">
            ...
            <ul class="clearfix">
                <li>
                    <span class="image"><img src="/themes/{{Cache::get('theme_name')}}/images/magazine_1.jpg"
                            alt=""></span>
                    Men’s health
                    <span class="date">{{__('megaextaz_home.June 2013')}}</span>
                </li>
                <li>
                    <span class="image"><img src="/themes/{{Cache::get('theme_name')}}/images/magazine_2.jpg"
                            alt=""></span>
                    Playboy
                    <span class="date">{{__('megaextaz_home.June 2013')}}</span>
                </li>
                <li>
                    <span class="image"><img src="/themes/{{Cache::get('theme_name')}}/images/magazine_3.jpg"
                            alt=""></span>
                    Cosmopolitan
                    <span class="date">{{__('megaextaz_home.June 2013')}}</span>
                </li>
        ...
        <div class="reviews cnt_wrapp clearfix">
            ...
            <div class="reviews_box">
                ...
                <ul>
                    <li>{{__('megaextaz_home.Igor Belanov')}} <img src="/themes/{{Cache::get('theme_name')}}/images/reviews_1.png"></li>
            ...
            <div class="reviews_box">
                ...
                <ul>
                    <li>{{__('megaextaz_home.Irina Pirozhkova')}} <img src="/themes/{{Cache::get('theme_name')}}/images/reviews_2.png"></li>
                    <li>{{__('megaextaz_home.23 years old')}}</li>
                </ul>
            </div>
            <div class="reviews_box">
                ...
                <ul>
                    <li>{{__('megaextaz_home.Albert Medvedev')}} <img src="/themes/{{Cache::get('theme_name')}}/images/reviews_3.png"></li>
        ...
        <div class="how_order cnt_wrapp clearfix">
            ...
            <ul class="clearfix">
                ...
                <li class="li3">{{__('megaextaz_home.Pay for the parcel')}} <br>{{__('megaextaz_home.upon receipt')}}</li>
            </ul>
        </div><!-- /.how_order -->
