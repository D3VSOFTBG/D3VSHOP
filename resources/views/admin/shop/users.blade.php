        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <form action="{{route('admin.shop.users.create')}}" method="post" class="d-inline">
                        @csrf
                        <!-- Modal -->
                                ...
                                <table class="table table-bordered m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <form action="{{route('admin.shop.users.delete')}}" method="post"
                                                    class="d-inline"
                                                ...
                                                <form action="{{route('admin.shop.users.edit')}}" method="post" class="d-inline">
                                                    @csrf
